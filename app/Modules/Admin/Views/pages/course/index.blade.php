    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var table = $('#table-post').DataTable({
                ...
                serverSide: true,
                ajax:{
                    url:  '{!! route('admin.course.getData') !!}',
                    data: function(d){
                ...
                columns: [
                   ...
                   {data: 'tour_code', name: 'tour_code', 'orderable': false},
               ...
               initComplete: function(){
                    ...
                    $('#btn-updateOrder').click(function(){
                        ...
                        $.ajax({
                            url: '{{route("admin.course.postAjaxUpdateOrder")}}',
                            type:'POST',
                    ...
                    $('input[name="status"]').on('change', function(){
                        ...
                        var id = $(this).data('id');
                        $.ajax({
                            url: '{{route("admin.course.postAjaxUpdateStatus")}}',
                            type:'POST',
