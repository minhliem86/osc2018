		...
		<div class="container-fluid">
			{!!Form::open(array('route'=>array('admin.country.store'),'class'=>'formAdmin form-horizontal','files'=>true))!!}
				...
				<div class="form-group">
					...
					<div>
						<span class="inline-radio"><input type="radio" name="multi_countries" value="1" checked=""> <b>Yest</b> </span>
						<span class="inline-radio"><input type="radio" name="multi_countries" value="0" > <b>No</b> </span>
					</div>
				</div>
				<div class="form-group">
					<label for="">Show follow</label>
					<div>
						<span class="inline-radio"><input type="radio" name="home_show" value="1" checked=""> <b>Yest</b> </span>
						<span class="inline-radio"><input type="radio" name="home_show" value="0" > <b>No</b> </span>
					</div>
				</div>
				<div class="form-group">
